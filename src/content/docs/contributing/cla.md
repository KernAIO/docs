...
description: What you agree to when contributing to any KernAIO repository.
---
...
Opening a pull request constitutes acceptance. A bot may ask you to confirm by commenting:

```
I have read the CLA Document and I hereby sign the CLA
```

Sign once; it covers all KernAIO repositories.
